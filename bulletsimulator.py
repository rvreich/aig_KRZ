...
aimX = float(input("Shooting direction [Horizontal] (0 to 360 degrees): ")) % 360
...
windDirection = float(input("Wind Direction (0 to 360 degrees): ")) % 360
